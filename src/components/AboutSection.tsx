        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 md:gap-8 lg:gap-16 xl:gap-20">
            ...
            <motion.div
              ...
              className="flex flex-col items-center lg:items-start justify-between lg:col-span-2 xl:col-span-2"
            >
            ...
            >
              ...
              <div className="inline-flex items-center space-x-2 mb-4 md:mb-6">
                ...
                <span className="text-[#161618] font-helvetica text-[20px] font-normal leading-[24px] tracking-[-0.4px] uppercase">
              ...
              <div className="w-full lg:w-[60%]">
                <div className="relative aspect-[16/9] lg:aspect-auto md:h-full h-[371px] w-full rounded-2xl overflow-hidden bg-gray-100">
                  ...
                  <button
                    ...
                    className="absolute left-2 cursor-pointer md:left-4 bottom-[10px] w-10 h-10 md:w-12 md:h-12 border border-white rounded-full flex items-center justify-center hover:bg-white/10 transition"
                  ...
                  <button
                    onClick={goToNext}
                    className="absolute right-2 cursor-pointer md:right-4 bottom-[10px] w-10 h-10 md:w-12 md:h-12 border border-white rounded-full flex items-center justify-center hover:bg-white/10 transition"
                ...
                <AnimatePresence mode="wait">
                  {currentProduct && (
                    ...
                    >
                      ...
                      <p className="text-[#7F7F7F] font-helvetica text-[20px] font-normal leading-[24px] tracking-[-0.4px] mb-[24px]">
                        {currentProduct.description}
                      </p>
                      <motion.a
                        href={currentProduct.buttonLink}
                        className="inline-flex items-center text-[#161618] font-helvetica text-[20px] gap-3 font-medium leading-[24px] tracking-[-0.4px] cursor-pointer"
                        whileHover={{ x: 5 }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
