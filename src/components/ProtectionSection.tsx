...
const ProtectionSection: React.FC<ProtectionSectionProps> = ({ data }) => {
  ...
  return (
    <section className="py-[30px] md:py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto  px-5">
        ...
        >
          ...
          <motion.div
            ...
            className="my-0 mx-auto max-w-[820px] pt-3 border-t border-black mb-[67px] md:mb-12 lg:mb-[90px]"
          >
            {/* Section Label */}
        ...
        <motion.div
            variants={containerVariants}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[54px] md:gap-8 lg:gap-12 max-w-[305px] m-auto md:max-w-fit"
          >
...
const CountCard: React.FC<{ item: CountItem; index: number }> = React.memo(({ item, index }) => {
  return (
    ...
    >
      <div className="text-[rgba(22,22,24,0.5)] text-center text-[16px] md:text-[18px] lg:text-[20px] not-italic font-normal leading-[120%] tracking-[-0.4px] pb-[31px] lg:pb-[30px] border-b border-[#777777] font-helvetica">
        {item.name}
      </div>
      <div className="text-[#7F7F7F] text-[16px] md:text-[18px] lg:text-[20px] not-italic font-medium leading-[120%] tracking-[-0.4px] uppercase font-helvetica pt-6 lg:pt-[24px] text-center">
        {item.title}
      </div>
    </motion.div>
  )
