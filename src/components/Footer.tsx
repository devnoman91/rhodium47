...
const Footer = () => {
  ...
  return (
    <footer className="relative text-white overflow-hidden px-5 bg-[#560100]">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-[35%_55%] gap-8 lg:gap-0 lg:justify-between">
              ...
              <div className="md:col-span-2 lg:col-span-1">
                <div>
                  ...
                  <button
                    onClick={() => {
                      if (footerData.learnMoreLink) {
                        window.location.href = footerData.learnMoreLink
                      }
                    }}
                    className="cursor-pointer border-b border-white pt-3 md:pt-4 lg:pt-[14px] text-white font-helvetica text-[16px] md:text-[18px] lg:text-[20px] not-italic font-normal leading-[28px] md:leading-[30px] lg:leading-[34px] tracking-[-0.32px] md:tracking-[-0.36px] lg:tracking-[-0.4px]"
                  >
                    {footerData.learnMoreText}
                  </button>
                </div>
                ...
                <div className="max-w-xl lg:max-w-2xl pt-6 md:pt-8 md:block hidden" >
                  ...
                  <form onSubmit={handleMainSubscription} className="max-w-[320px] md:max-w-[370px] mt-3 md:mt-[14px] flex items-center px-4 md:px-[20px] py-3 md:py-[16px] gap-3 md:gap-[16px] self-stretch rounded-[70px] border border-white">
                    <input
                      ...
                      required
                      className="w-full focus:outline-none text-white font-helvetica text-[14px] md:text-[16px] not-italic font-normal leading-[20px] md:leading-[28px] tracking-[-0.28px] md:tracking-[-0.38px] bg-transparent placeholder-white"
                    />
                    <button
                      type="submit"
          ...
          <div className="border-t border-white pt-6 md:pt-8 lg:pt-[40px] pb-[40px] max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
            ...
            <div className="flex space-x-3 md:space-x-4">
              {footerData.socialLinks.facebook && (
                <a href={footerData.socialLinks.facebook} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#560100] flex items-center justify-center hover:bg-[#42424280] transition-colors">
              ...
              {footerData.socialLinks.twitter && (
                <a href={footerData.socialLinks.twitter} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#560100] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              {footerData.socialLinks.instagram && (
                <a href={footerData.socialLinks.instagram} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#560100] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              {footerData.socialLinks.linkedin && (
                <a href={footerData.socialLinks.linkedin} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#560100] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
