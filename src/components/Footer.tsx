          ...
          <div className="border-t border-white pt-6 md:pt-8 lg:pt-[40px] pb-[40px] max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
            ...
            <div className="flex space-x-3 md:space-x-4">
              {footerData.socialLinks.facebook && (
                <a href={footerData.socialLinks.facebook} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#32323287] flex items-center justify-center hover:bg-[#42424280] transition-colors">
              ...
              {footerData.socialLinks.twitter && (
                <a href={footerData.socialLinks.twitter} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#32323287] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              {footerData.socialLinks.instagram && (
                <a href={footerData.socialLinks.instagram} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#32323287] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              {footerData.socialLinks.linkedin && (
                <a href={footerData.socialLinks.linkedin} className="w-10 h-10 md:w-12 md:h-12 lg:w-[48px] lg:h-[48px] rounded-[100px] border border-[rgba(99,109,121,1)] bg-[#32323287] flex items-center justify-center hover:bg-[#42424280] transition-colors">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
