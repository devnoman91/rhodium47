      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-end space-x-8">
          <div className="hidden md:flex items-center space-x-8 gap-[20px]">
            <Link href="/vehicles" className="font-helvetica leading-[24px] hover:opacity-80 transition-opacity tracking-[0] m-0 px-[20px] py-0 font-light text-[16px] text-white">
              Vehicles
            </Link>
            <Link href="/discover" className="font-helvetica leading-[24px] hover:opacity-80 transition-opacity tracking-[0] m-0 px-[20px] py-0 font-light text-[16px] text-white">
              Discover
            </Link>
            <Link href="/inventory" className="font-helvetica leading-[24px] hover:opacity-80 transition-opacity tracking-[0] m-0 px-[20px] py-0 font-light text-[16px] text-white">
              Shop
            </Link>
            <Link href="/support" className="font-helvetica leading-[24px] hover:opacity-80 transition-opacity tracking-[0] m-0 px-[20px] py-0 font-light text-[16px] text-white">
              Support
            </Link>
          </div>
